...
| ttl           |               number | —                                    | Time to live in milliseconds. If set, saved data will automatically expire after this duration. On restore, expired data is cleared and not restored. |
